...
project = u'Invenio-GitLab'
copyright = u'2018, HZDR'
author = u'HZDR'
...
htmlhelp_basename = 'invenio-gitlab_namedoc'
...
latex_documents = [
    (master_doc, 'invenio-gitlab.tex', u'invenio-gitlab Documentation',
     u'HZDR', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-gitlab', u'invenio-gitlab Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'invenio-gitlab', u'Invenio-GitLab Documentation',
     author, 'invenio-gitlab', 'Module for Invenio that adds GitLab integration.',
     'Miscellaneous'),
]
